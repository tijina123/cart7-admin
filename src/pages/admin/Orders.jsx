        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-5 relative max-h-[80vh] overflow-y-auto">
            ...
            <div className="border-b pb-2 mb-2">
              ...
              <p>
                <strong>Address:</strong> {selectedOrder?.user?.name}
              </p>
               <p>
                <strong>Phone Number:</strong> {selectedOrder?.user?.name}
              </p>
               <p>
...
//               <h3 className="text-lg font-semibold mb-1">User Details</h3>
//               <p>
//                 <strong>Order Id:</strong> {selectedOrder?.order?._id}
//               </p>
//               <p>
//                 <strong>Order Date:</strong> {selectedOrder?.user?.name}
//               </p>
//               <p>
//                 <strong>Name:</strong> {selectedOrder?.user?.name}
//               </p>
...
//               </p>
//                <p>
//                 <strong>Status:</strong> {selectedOrder?.user?.name}
//               </p>
//             </div>
